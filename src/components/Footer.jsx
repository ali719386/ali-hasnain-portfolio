...
const SOCIALS = [
  ...
  },
  {
    key: 'facebook',
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=100052953360998',
    icon: (
      <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor">
  ...
  },
  {
    key: 'twitter',
    label: 'Twitter',
    href: 'https://x.com/ali_hasnai28019?s=11',
    icon: (
      <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor">
  ...
  },
  {
    key: 'instagram',
    label: 'Instagram',
    href: 'https://www.instagram.com/alihasnainn16/',
    icon: (
  ...
  },
  {
    key: 'linkedin',
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/ali-hasnain-483921258',
    icon: (
      <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor">
  ...
  return (
    <footer className="footer">
      <div className="wrap footer-inner">
        <span className="footer-copy">&copy; ALI HASNAIN {year}. All rights reserved.</span>
